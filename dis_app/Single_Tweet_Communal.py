...
# 	# except Exception as e:
	...
	# print(main("Evangelist poachers coming to help #NepalEarthquake victims in return of conversion. May God unleash hell upon them http://t.co/S08EemybTu"))
